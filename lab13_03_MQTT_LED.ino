...
const char WIFI_SSID[] = "Wonderland";          // CHANGE TO YOUR WIFI SSID
const char WIFI_PASSWORD[] = "11111111";  // CHANGE TO YOUR WIFI PASSWORD
...
const char MQTT_CLIENT_ID[] = "66070180";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";                        // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";                        // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "phycom_66070316";       // CHANGE IT AS YOU DESIRE
